...
% Table generated by Excel2LaTeX from sheet 'Tabelas'
%\begin{table}[htbp]
%	\centering
%	\caption{Tabela com as massas em cada etapa do procedimento}
%	\begin{tabular}{|c|c|c|c|}
%		\toprule
%		\textbf{Numeração} & \multicolumn{1}{p{11.93em}|}{\textbf{Massa Úmida\newline{}g}} & \multicolumn{1}{p{12.285em}|}{\textbf{Massa Seca\newline{}g}} & \multicolumn{1}{p{10.855em}|}{\textbf{\% Sólidos}} \\
%		\midrule
%		S1    & 3,5899 & 0,1405 & 0,03913758 \\
%		\midrule
%		S2    & 3,4475 & 0,1342 & 0,038926759 \\
%		\midrule
%		S3    & 3,65  & 0,143 & 0,039178082 \\
%		\bottomrule
%	\end{tabular}%
%	\label{tab:addlabel}%
%\end{table}%
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[scale=.7,trim={0 0 0 0}]{figuras/ladeq/sedi/graphBiscaia}
		%\vspace{-20pt}
		\caption{Representação gráfica do método de Biscaia Jr.}
		\label{tabqua1}
	\end{center}
...
Vazões volumétrica, vazão mássica e concentração de sólidos da suspensão utilizada na alimentação do teste de proveta podem ser observadas na Tabela \ref{tabalim}.
...
\begin{table}[H]
	...
	\end{tabular}
	\caption{Vazões e concentração na alimentação do teste de proveta.}
	\label{tabalim}
\end{table}
...
\begin{table}[H]
	...
	\end{tabular}
	\caption{Vazões e concentração no retido do teste de proveta.}
	\label{tabretido}
\end{table}
...
\begin{table}[H]
	...
	\end{tabular}
	\caption{Vazões e concentração no passante do teste de proveta.}
	\label{passante}
\end{table}
